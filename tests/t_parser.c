...
static void test_action(gconstpointer backend) {
    const HParser *action_ = h_action(h_sequence(h_choice(h_ch('a'), h_ch('A'), NULL),
                                                 h_choice(h_ch('b'), h_ch('B'), NULL), NULL),
                                      upcase, NULL);

    g_check_parse_match(action_, (HParserBackend)GPOINTER_TO_INT(backend), "ab", 2,
                        "(u0x41 u0x42)");
    g_check_parse_match(action_, (HParserBackend)GPOINTER_TO_INT(backend), "AB", 2,
                        "(u0x41 u0x42)");
...
static void test_sequence(gconstpointer backend) {
    ...
    g_check_parse_match(sequence_1, (HParserBackend)GPOINTER_TO_INT(backend), "ab", 2,
                        "(u0x61 u0x62)");
    ...
    g_check_parse_match(sequence_2, (HParserBackend)GPOINTER_TO_INT(backend), "ab", 2,
                        "(u0x61 u0x62)");
    g_check_parse_match(sequence_2, (HParserBackend)GPOINTER_TO_INT(backend), "a b", 3,
                        "(u0x61 u0x62)");
    g_check_parse_match(sequence_2, (HParserBackend)GPOINTER_TO_INT(backend), "a  b", 4,
                        "(u0x61 u0x62)");
...
static void test_many(gconstpointer backend) {
    ...
    g_check_parse_match(many_, (HParserBackend)GPOINTER_TO_INT(backend), "aabbaba", 7,
                        "(u0x61 u0x61 u0x62 u0x62 u0x61 u0x62 u0x61)");
    //  g_check_parse_match(many_, (HParserBackend)GPOINTER_TO_INT(backend), "aabbabadef", 10,
    //  "(u0x61 u0x61 u0x62 u0x62 u0x61 u0x62 u0x61)"); g_check_parse_match(many_,
    //  (HParserBackend)GPOINTER_TO_INT(backend), "daabbabadef", 11, "()");
}
...
static void test_many1(gconstpointer backend) {
    ...
    g_check_parse_match(many1_, (HParserBackend)GPOINTER_TO_INT(backend), "aabbaba", 7,
                        "(u0x61 u0x61 u0x62 u0x62 u0x61 u0x62 u0x61)");
    //  g_check_parse_match(many1_, (HParserBackend)GPOINTER_TO_INT(backend), "aabbabadef", 10,
    //  "(u0x61 u0x61 u0x62 u0x62 u0x61 u0x62 u0x61)");
...
static void test_repeat_n(gconstpointer backend) {
    ...
    g_check_parse_match(repeat_n_, (HParserBackend)GPOINTER_TO_INT(backend), "abdef", 5,
                        "(u0x61 u0x62)");
...
static void test_optional(gconstpointer backend) {
    const HParser *optional_ =
        h_sequence(h_ch('a'), h_optional(h_choice(h_ch('b'), h_ch('c'), NULL)), h_ch('d'), NULL);

    g_check_parse_match(optional_, (HParserBackend)GPOINTER_TO_INT(backend), "abd", 3,
                        "(u0x61 u0x62 u0x64)");
    g_check_parse_match(optional_, (HParserBackend)GPOINTER_TO_INT(backend), "acd", 3,
                        "(u0x61 u0x63 u0x64)");
    g_check_parse_match(optional_, (HParserBackend)GPOINTER_TO_INT(backend), "ad", 2,
                        "(u0x61 null u0x64)");
...
static void test_ignore(gconstpointer backend) {
    ...
    g_check_parse_match(ignore_, (HParserBackend)GPOINTER_TO_INT(backend), "abc", 3,
                        "(u0x61 u0x63)");
...
static void test_sepBy(gconstpointer backend) {
    ...
    g_check_parse_match(sepBy_, (HParserBackend)GPOINTER_TO_INT(backend), "1,2,3", 5,
                        "(u0x31 u0x32 u0x33)");
    g_check_parse_match(sepBy_, (HParserBackend)GPOINTER_TO_INT(backend), "1,3,2", 5,
                        "(u0x31 u0x33 u0x32)");
    g_check_parse_match(sepBy_, (HParserBackend)GPOINTER_TO_INT(backend), "1,3", 3,
                        "(u0x31 u0x33)");
...
static void test_sepBy1(gconstpointer backend) {
    ...
    g_check_parse_match(sepBy1_, (HParserBackend)GPOINTER_TO_INT(backend), "1,2,3", 5,
                        "(u0x31 u0x32 u0x33)");
    g_check_parse_match(sepBy1_, (HParserBackend)GPOINTER_TO_INT(backend), "1,3,2", 5,
                        "(u0x31 u0x33 u0x32)");
    g_check_parse_match(sepBy1_, (HParserBackend)GPOINTER_TO_INT(backend), "1,3", 3,
                        "(u0x31 u0x33)");
...
static void test_epsilon_p(gconstpointer backend) {
    ...
    g_check_parse_match(epsilon_p_1, (HParserBackend)GPOINTER_TO_INT(backend), "ab", 2,
                        "(u0x61 u0x62)");
...
static void test_attr_bool(gconstpointer backend) {
    const HParser *ab_ =
        h_attr_bool(h_many1(h_choice(h_ch('a'), h_ch('b'), NULL)), validate_test_ab, NULL);
...
static void test_not(gconstpointer backend) {
    const HParser *not_1 = h_sequence(
        h_ch('a'), h_choice(h_ch('+'), h_token((const uint8_t *)"++", 2), NULL), h_ch('b'), NULL);
    const HParser *not_2 = h_sequence(h_ch('a'),
                                      h_choice(h_sequence(h_ch('+'), h_not(h_ch('+')), NULL),
                                               h_token((const uint8_t *)"++", 2), NULL),
                                      h_ch('b'), NULL);

    g_check_parse_match(not_1, (HParserBackend)GPOINTER_TO_INT(backend), "a+b", 3,
                        "(u0x61 u0x2b u0x62)");
    g_check_parse_failed(not_1, (HParserBackend)GPOINTER_TO_INT(backend), "a++b", 4);
    g_check_parse_match(not_2, (HParserBackend)GPOINTER_TO_INT(backend), "a+b", 3,
                        "(u0x61 (u0x2b) u0x62)");
    g_check_parse_match(not_2, (HParserBackend)GPOINTER_TO_INT(backend), "a++b", 4,
                        "(u0x61 <2b.2b> u0x62)");
}
...
static void test_leftrec_ne(gconstpointer backend) {
    ...
    g_check_parse_match(lr_, (HParserBackend)GPOINTER_TO_INT(backend), "aaa", 3,
                        "((u0x61 u0x61) u0x61)");
...
static void test_rightrec(gconstpointer backend) {
    ...
    g_check_parse_match(rr_, (HParserBackend)GPOINTER_TO_INT(backend), "aaa", 3,
                        "(u0x61 (u0x61 (u0x61)))");
}
...
static void test_iterative_single(gconstpointer backend) {
    ...
    p = h_choice(h_token((uint8_t *)"foobar", 6), h_token((uint8_t *)"phupar", 6), NULL);
    g_check_parse_chunk_match(p, be, "foobar", 6, "<66.6f.6f.62.61.72>");
    g_check_parse_chunk_match(p, be, "foobarbaz", 9, "<66.6f.6f.62.61.72>");
    ...
    p = h_sequence(h_ch('f'),
                   h_choice(h_token((uint8_t *)"oo", 2), h_token((uint8_t *)"uu", 2), NULL), NULL);
...
static void test_iterative_lookahead(gconstpointer backend) {
    ...
    // needs 2 lookahead
    p = h_sequence(h_ch('f'),
                   h_choice(h_token((uint8_t *)"oo", 2), h_token((uint8_t *)"ou", 2), NULL), NULL);
...
static void test_put_get(gconstpointer backend) {
    HParser *p =
        h_sequence(h_put_value(h_uint8(), "size"), h_token((const uint8_t *)"foo", 3),
                   h_length_value(h_action(h_get_value("size"), act_get, NULL), h_uint8()), NULL);
    // Yes, the quotes in the next line look weird. Leave them alone,
    // this is to deal with how C strings handle hex-formatted chars.
    g_check_parse_match(p, (HParserBackend)GPOINTER_TO_INT(backend),
                        "\x01"
                        "fooabcdef",
                        10, "(u0x1 <66.6f.6f> (u0x61 u0x62 u0x63 u0x64 u0x65 u0x66))");
    g_check_parse_failed(p, (HParserBackend)GPOINTER_TO_INT(backend),
                         "\x01"
                         "fooabcde",
                         9);
}
...
static void test_action_stash_discards_failed_branch(gconstpointer backend) {
    ...
    HParser *stale_stash = h_action_stash(h_ch('A'), stash_count_action, &stale_count, &actions);
    HParser *stash_b = h_action_stash(h_ch('A'), stash_count_action, &committed_count, &actions);

    HParser *losing_branch = h_sequence(stale_stash, h_ch('B'), h_ch('X'), NULL);
    HParser *winning_branch = h_sequence(stash_b, h_ch('B'), NULL);
    HParser *parser = h_action_apply(h_choice(losing_branch, winning_branch, NULL), &actions);
...
static void test_action_stash_survives_ignore(gconstpointer backend) {
    ...
    HParser *stash = h_action_stash(h_ch('A'), stash_count_action, &applied_count, &actions);
...
static void test_action_stash_packrat_memo_replay(void) {
    ...
    HParser *parser = h_action_apply(h_choice(losing_branch, stash, NULL), &actions);
...
static void test_h_action_apply(gconstpointer backend) {
    ...
    HParser *parser = h_action_stash(h_uint8(), func, NULL, &action);
    HParser *seq = h_action_apply(h_sequence(h_uint8(), parser, h_uint8(), NULL), &action);

    // should now be the transformed AST.
    g_check_parse_match(seq, (HParserBackend)GPOINTER_TO_INT(backend), "\x01\x01\x01", 3,
                        "(u0x1 null u0x1)");
}
...
static void test_action_stash_choice(void) {
    ...
    buf[2] = (uint8_t)'A';
    HActionCollection action = {0};
    HParser *parser1 = h_action_stash(h_ch('D'), fail_func, NULL, &action);
    HParser *parser2 =
        h_action_stash(h_uint8(), func, NULL, &action); // Only this parser should apply
    HParser *parser3 = h_action_stash(h_uint8(), fail_func, NULL, &action);
...
static void test_action_apply_fail(void) {
    ...
    buf[2] = (uint8_t)'A';
    HActionCollection action = {0};
    HParser *parser = h_action_stash(h_uint8(), fail_func, NULL, &action);
...
static void test_action_apply_choice(void) {
    ...
    HParser *parser = h_action_apply(
        h_choice(h_action_stash(h_int32(), func, NULL, &action), h_uint8(), NULL), &action);
...
void register_parser_tests(void) {
    ...
    g_test_add_data_func("/core/parser/packrat/nothing_p", GINT_TO_POINTER(PB_PACKRAT),
                         test_nothing_p);
    g_test_add_data_func("/core/parser/packrat/sequence", GINT_TO_POINTER(PB_PACKRAT),
                         test_sequence);
    ...
    g_test_add_data_func("/core/parser/packrat/difference", GINT_TO_POINTER(PB_PACKRAT),
                         test_difference);
    ...
    g_test_add_data_func("/core/parser/packrat/epsilon_p", GINT_TO_POINTER(PB_PACKRAT),
                         test_epsilon_p);
    g_test_add_data_func("/core/parser/packrat/attr_bool", GINT_TO_POINTER(PB_PACKRAT),
                         test_attr_bool);
    ...
    g_test_add_data_func("/core/parser/packrat/leftrec-ne", GINT_TO_POINTER(PB_PACKRAT),
                         test_leftrec_ne);
    g_test_add_data_func("/core/parser/packrat/rightrec", GINT_TO_POINTER(PB_PACKRAT),
                         test_rightrec);
    g_test_add_data_func("/core/parser/packrat/endianness", GINT_TO_POINTER(PB_PACKRAT),
                         test_endianness);
    g_test_add_data_func("/core/parser/packrat/putget", GINT_TO_POINTER(PB_PACKRAT), test_put_get);
    g_test_add_data_func("/core/parser/packrat/permutation", GINT_TO_POINTER(PB_PACKRAT),
                         test_permutation);
    g_test_add_data_func("/core/parser/packrat/bind", GINT_TO_POINTER(PB_PACKRAT), test_bind);
    g_test_add_data_func("/core/parser/packrat/result_length", GINT_TO_POINTER(PB_PACKRAT),
                         test_result_length);
    ...
    g_test_add_data_func("/core/parser/packrat/iterative/lookahead", GINT_TO_POINTER(PB_PACKRAT),
                         test_iterative_lookahead);
    g_test_add_data_func("/core/parser/packrat/iterative/seek", GINT_TO_POINTER(PB_PACKRAT),
                         test_iterative_seek);
    ...
    g_test_add_data_func("/core/parser/h_action_stash/failed_branch/packrat",
                         GINT_TO_POINTER(PB_PACKRAT), test_action_stash_discards_failed_branch);
    g_test_add_data_func("/core/parser/h_action_stash/failed_branch/regex",
                         GINT_TO_POINTER(PB_REGULAR), test_action_stash_discards_failed_branch);
    g_test_add_data_func("/core/parser/h_action_stash/failed_branch/glr", GINT_TO_POINTER(PB_GLR),
    ...
    g_test_add_data_func("/core/parser/h_action_apply/enclosing_failure/llk",
                         GINT_TO_POINTER(PB_LL), test_action_apply_discards_on_enclosing_failure);
    g_test_add_data_func("/core/parser/h_action_apply/enclosing_failure/lalr",
                         GINT_TO_POINTER(PB_LALR), test_action_apply_discards_on_enclosing_failure);
    g_test_add_data_func("/core/parser/h_action_apply/enclosing_failure/glr",
                         GINT_TO_POINTER(PB_GLR), test_action_apply_discards_on_enclosing_failure);
